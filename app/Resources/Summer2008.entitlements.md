...
| `com.apple.security.automation.apple-events` | Director projector windows are positioned, focused and torn down through the Accessibility APIs, i.e. automation of another process. |
