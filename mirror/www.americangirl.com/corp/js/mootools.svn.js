...
Element.extend({
	...
	*/
	...
	Example:
		...
		<img src="../includes/whatever.gif" alt="whatever dude">
		(end)
	*/
...
Element.extend({
	...
	*/
	...
	Example:
		(start code)
		<form id="myForm" action="../includes/submit.php">
	...
	add: function(fn){
		...
		if (document.readyState && window.webkit){
			...
			if (!$('ie_ready')){
				...
				document.write('<script id="ie_ready" defer src="../includes/' + src + '"><\/script>');
