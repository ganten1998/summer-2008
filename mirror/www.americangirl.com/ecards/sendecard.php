...
<!-- #EndLibraryItem --><br>
<div align="center">
<table width="661" border="0" cellpadding="6" cellspacing="3" class="content"><tr><td height="1">&nbsp;</td>
</tr>
  <tbody>
  

  <tr>
    <td width="643" height="21" colspan="5" rowspan="1" class="headingEcard"><a href="index.php"><img src="images/ecardstamp.gif" width="112" height="85" border="0"></a></td>
	</tr>

 
  
  <tr>
    <td colspan="5" height="21" class="textEcard" valign="top">Thank You! Your
      card has been sent.</td>
    </tr>
 
  <tr>
    <td colspan="5" class="textEcard" valign="top">Click the button below to send the same E-Card to someone else.</td>
	</tr>
  
  <tr>
    <td colspan="5" height="22">
  
<a href="/ecards/customize.php?ecard_id=&action=resend&ecard=5937af34c18e36fc77e0f9640e873fc4">
<img src="images/ecc_button_else.jpg" width="154" height="31" border="0"></a>
  ...
  <tr>
    <td colspan="5" class="textEcard" valign="top">Click the button below to send a new E-Card.</td>
	</tr>

  <tr>
    <td colspan="5" height="22">
	<a href="index.php"><img src="images/ecc_button_new.jpg" width="101" height="33" border="0"></a>
	</td>
	</tr>
</tbody></table>
</div>
