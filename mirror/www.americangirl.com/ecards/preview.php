...
<!-- #EndLibraryItem -->
<table width="737" border="0" align="center" cellpadding="1" cellspacing="1" class="content"><tr><td colspan="3" height="15">&nbsp;</td></tr>
<tr>
  <td width="115" rowspan="3" align="left" valign="top" class="textEcard"><p align="center"><br>
        <a href="index.php"><img src="/ecards/images/ecardstamp.gif" width="112" height="85" border="0" align="bottom"></a><BR>
        <BR>
        <img src="/ecards/images/playectxt.gif"></p>
		<p>Click Play to view your personalized
        E-Card. </p>
      <p >To make changes or to send, click the Customize your E-Card button. </p>
    </td>
  <td width="1" rowspan="2" align="center" valign="middle"><img src="/ecards/images/vertical_rule.gif" width="1" height="100%"></td>
      <td width="611" height="361" align="center" valign="top">
	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="600" height="350">
          <param name="movie" value='?personalMsg='>
          <param name="quality" value="high">
      <embed src='?personalMsg=' width="600" height="350" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed></object>
    <BR></td>
    </tr>
<tr>
  <td width="611" height="41" align="right" valign="bottom" nospan>

	  
	 <form name="ecard" method="post" action='customize.php' >
	  ...
	  <input type="hidden" name='cur_month' value='' >
	  <input type="hidden" name='cur_day' value='' >
	  <input type="hidden" name='cur_year' value='' >
	  <input type="hidden" name='notify_flag' value='' >
	 
	  
	  <input type="image" src="images/ecc_button_custom.jpg" name="Submit" value="Submit" border="0">
	  
	  
	<img src="/ecards/images/spacer.gif" width="20" height="10" border='0'>
	...
	<tr>
      ...
      Note: Flash  v8.0 or above is required to view the above
       E-Card. See <a href="/tips/index.html">Online Tips</a> for more information
      on how to download this plug-in. </td>
    </tr>
</table>
